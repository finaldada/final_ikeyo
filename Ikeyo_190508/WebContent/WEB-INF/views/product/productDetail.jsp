...
<tr>
	...
	<td style="padding-bottom: 40%">
		...
		<tr>
			...
			<td>
			<span class="quantity">
				<input type="text" id="count" name="count" value="1" size="20" />&nbsp;&nbsp;
		...
		<tr>
			...
			<br/>
				<span style="text-align: right;"><b>총 상품금액</b>(수량) : 
					<input type="text" id="totalprice" name="totalprice" value="" readonly="readonly" style="text-align: right;"/> 
				</span>
				<br/><br/>
			</td>
		</tr>
