...
<br>
   <ul>
      <li>
      <div class="dropdown">
      <a class="dropdown-toggle" href="#"role="button" id="dropdownMenulist" 
               data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
               style="color: #535353; text-decoration: none;">
               <b>▤ 모든 제품</b>
         </a><b> ｜</b>
         <div class="dropdown-menu" aria-labelledby="dropdownMenulist">
            <a class="dropdown-item" href="productList.do?category=책상/테이블">책상/테이블</a>
            <a class="dropdown-item" href="productList.do?category=침대/매트리스">침대/매트리스</a>
            <a class="dropdown-item" href="productList.do?category=의자/소파">의자/소파</a>
            <a class="dropdown-item" href="productList.do?category=옷장/수납장">옷장/수납장</a>
            <a class="dropdown-item" href="productList.do?category=액세서리">액세서리</a>
         </div>
         </div>   
      </li>
   </ul>
     <ul>
      <li>
        ...
        <li style="margin-left: 25%;"><b><a href="calendar.do" style="color:#535353; text-decoration: none;" title="출석체크" class="test">&nbsp;｜<img src="image/AC_20190530-145249.gif"> ｜</a></b></li>
       ...
       <%--  <c:if test="${not empty login && login.id ne ''}">   
        ...
        <c:if test="${not empty login && login.id ne ''}">   
         <li><b><a href="logout.do" title="로그아웃" style="text-decoration: none;">&nbsp;<img src="image/ico-login.png"></a>｜</b></li>
         <li><b><a href="myorder.do" style="color:#535353; text-decoration: none;">&nbsp;마이페이지 ｜</a></b></li>
      </c:if>
