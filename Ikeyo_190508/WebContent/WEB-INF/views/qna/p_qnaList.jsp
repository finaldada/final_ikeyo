...
<c:if test="${not empty qlist }">
	<c:forEach items="${qlist }" var="qna" varStatus="vs">
		...
		<tr id="an${qna.qna_seq }" style="display:none; height: 80px; border-top: 1px solid #aaa; border-bottom: 1px solid #aaa;">
			<td style="vertical-align: middle; text-align: center;"><font style="color: red; font-size: 18px; font-family: 'Noto Sans KR'; font-weight: 800;">답변</font></td>
			<td style="vertical-align: middle; text-align: center;">
				<form id="_frmAnswer" action="" method="post">
...
function answer(qna_seq) {
	...
	$("#_frmAnswer").attr("action", "qnaAnswer.do").submit();
}
