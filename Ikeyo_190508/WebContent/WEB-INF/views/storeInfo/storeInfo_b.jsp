...
mapOption = {
    center: new daum.maps.LatLng(37.555999, 127.076147), // 지도의 중심좌표
    level: 2 // 지도의 확대 레벨
};  
...
//주소로 좌표를 검색합니다
geocoder.addressSearch('서울특별시 광진구 천호대로 512 군자빌딩', function(result, status) {
...
// 정상적으로 검색이 완료됐으면 
 if (status === daum.maps.services.Status.OK) {
    ...
    var infowindow = new daum.maps.InfoWindow({
        content: '<div style="width:150px;text-align:center;padding:6px 0;">중곡점 </div>'
    });
