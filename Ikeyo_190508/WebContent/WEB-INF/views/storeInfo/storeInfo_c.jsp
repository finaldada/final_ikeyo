...
mapOption = {
    center: new daum.maps.LatLng(37.5130004,127.0247225), // 지도의 중심좌표
    level: 2 // 지도의 확대 레벨
};  
...
//주소로 좌표를 검색합니다
geocoder.addressSearch('서울특별시 강남구 학동로 147', function(result, status) {
...
// 정상적으로 검색이 완료됐으면 
 if (status === daum.maps.services.Status.OK) {
    ...
    var infowindow = new daum.maps.InfoWindow({
        content: '<div style="width:150px;text-align:center;padding:6px 0;">논현점</div>'
    });
